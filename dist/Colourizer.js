...
const RequestCommands_1 = require("./RequestCommands");
...
class Colourizer {
    constructor() {
        ...
        this.requests = new RequestCommands_1.RequestCommands(this.connection, this);
        /************
         * COMMANDS *
         ************/
        this.getSetCommand = () => {
         ...
         * @memberof Colourizer
         */
        this.createChannelMessage = (message, opts, params, client, commander) => __awaiter(this, void 0, void 0, function* () {
    ...
    syncColourList(channel, guild) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const img = 'list.png';
            yield webshot_1.createShot(dom, img, {
                siteType: 'html',
                windowSize: {
